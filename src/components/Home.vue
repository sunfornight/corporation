<template>
    <el-container class="home-container">
        ...
        <el-header>
            ...
            <span class="head-title">公司客户信息</span>
    ...
    data(){
        return{
            ...
            iconsObjects:{
                ...
                '300':'iconfont icon-yonghuming',
                '102':'iconfont icon-weixin',
                '104':'iconfont icon-xiaoxi',
                '101':'iconfont icon-ziyuanguanli',
                '201':'iconfont icon-gailan',
                '301':'iconfont icon-jibenxinxi',
                '302':'iconfont icon-xianshi',
